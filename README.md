...
We included **NeuroHarmonize** (ComBat-GAM) in the repository, since we included in it harmonization assumptions checks (https://github.com/rpomponio/neuroHarmonize).
